...
4. Once verified, the amazee.ai credentials (LLM key and VectorDB key) will be stored in the **Keys** module at
   `/admin/config/system/keys`. ([drupal.org][1])
5. Go to **Configuration → AI → AI Default Settings** and select **Mistral-only** models for the relevant operation types.
